 ...
 * by multiple threads. It demonstrates how shared resources
 * such as booking queues and inventory must be accessed
        ...
        while (true) {
            ...
            synchronized (bookingQueue) {
                if (bookingQueue.hasPendingRequests()) {
                    ...
                    break; // Queue is empty, exit the thread loop
                }
            }
